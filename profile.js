        ...
        setTimeout(() => {
            resolve({
                ...
                devices: [
                    ...
                    { id: 'device2', name: 'Plant Sensor 2' }
                ]
            });
        }, 1000);
    });
...
async function fetchUserActivityHistory() {
    ...
    return new Promise(resolve => {
        setTimeout(() => {
            resolve([
                { date: '2025-01-10', deviceId: 'device1', activity: 'Device connected' },
                { date: '2025-01-12', deviceId: 'device2', activity: 'Battery low alert' },
                { date: '2025-01-15', deviceId: 'device1', activity: 'Device data updated' }
            ]);
        }, 1000);
    });
}
